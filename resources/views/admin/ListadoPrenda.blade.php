    ...
    <div
        ...
        <div class="size">
            <div class="navbar1 flex size">
                ...
                <div class="mx-auto ml-2 titulo texto-grande size"> CASA DE EMPEÑOS <br> ASOCIADOS NUEVA MUTUA DE UMÁN
                    S.A. DE C.V.</a></div>
            ...
            <div class="mt-8 size95 mx-auto items-center justify-center flex negritas">
                        ...
                        <table class="table table-sm mt-4 table-striped ">
                            ...
                            @foreach ($lista_prendas as $prenda)
                                <tr>
                                    ...
                                    <td>{{ toMoney($prenda->prestamo_inicial) }}
                                    </td>
                                    </td>
                                    ...
                                    @can('imprimir-boleta')
                                        <td>
                                            <a class="nav-link text-center"
                                                ...
                                                id="navbarDarkDropdownMenuLink" aria-expanded="false" target="_blank"><i
                                                    class="fa fa-print" style="font-size:30px"></i></a>
                                        </td>
                                    @endcan
                                </tr>
                            @endforeach
                ...
                @else
                    <div class="h3 text-center fw-bold mt-8">No tienes los permisos para ver este modulo <br> Comunicate con
                        tu superior...</div>
                @endcan
</body>
