                        ...
                        <form action="{{ route('Ticket_Desempeño') }}" method="GET">
                            <div class="col-md-3 d-flex  mt-2 ">
                                <input class="col-md-4 form-control text-center  me-2" type="search"
                                    placeholder="ingrese folio o número del cliente" name="search_ticket"
                                    aria-label="Search" value="{{ request('search_ticket') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div>
                                                ...
                                                <a class="nav-link"
                                                    href="{{ route('ticket.vistaTicket', [$tickets->id_folio]) }}"
