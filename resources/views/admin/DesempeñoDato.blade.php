        ...
        <div
            ...
            <div class="size">
                <div class="navbar1 flex size">
                    ...
                    <div class="mx-auto ml-2 titulo neritas texto-grande size"> CASA DE EMPEÑOS <br> ASOCIADOS NUEVA MUTUA
                        DE UMÁN S.A. DE C.V.</a></div>
                ...
                <div class="tabla justify-content-center mt-4">
                    <div class="tabla1 ">
                            ...
                            <table class="table table-sm mt-3">
                                ...
                                <tr>
                                    ...
                                    <td style="background-color: yellow;" class="fw-bold">
                                        {{ toMoney($dato_prenda->desempeño) }}</td>
                        ...
                        <div class="text-center mt-3">
                            <label for="">--------------------------------- <strong>DATOS DEL
                                    CLIENTE/PRENDA</strong> ----------------------------------</label>
                        </div>
                        ...
                        <div class="col-md-11 mt-4 letra1">
                            ...
                            <label class="mt-2"><strong>CARACTERÍSTICAS:&nbsp;&nbsp;</strong>
                                @if ($dato_prenda->status == 1)
                                    {{ $dato_prenda->caracteristicas_prenda }}@else{{ $dato_prenda->caracteristicas_prenda . '.' . ' ' . 'DETALLES ESPECIFICOS:' . ' KILATAJE:' . '' . ' ' . $dato_prenda->kilataje_prenda . 'k' . ',' . ' ' . 'GRAMAJE:' . '' . ' ' . $dato_prenda->gramaje_prenda . 'gr' }}
                                @endif
                            </label>
                            <label class="mt-1"><strong>CANTIDAD DE REFRENDOS
                                    REALIZADOS:&nbsp;&nbsp;</strong>#{{ $dato_prenda->numeros_refrendos }}</label> <br>
                            <label class="mt-1"><strong>- ULTIMO PAGO REALIZADO
                                    (REFRENDO):&nbsp;&nbsp;</strong>{{ toMoney($dato_prenda->refrendo_anterior) }}</label>
                            <br>
                            <label class="mt-1"><strong>CANTIDAD DE ABONOS A CAPITAL
                                    REALIZADOS:&nbsp;&nbsp;</strong>#{{ $dato_prenda->numeros_capital }}</label> <br>
                            <label class="mt-1"><strong>- ULTIMO PAGO REALIZADO
                                    (CAPITAL):&nbsp;&nbsp;</strong>{{ toMoney($dato_prenda->total_capi) }}</label> <br>
                            <label class="mt-1"><strong>PRÉSTAMO
                                    INICIAL:&nbsp;&nbsp;</strong>{{ toMoney($dato_prenda->prestamo_inicial) }}</label>
                        </div>
                    ...
                    <div class="tabla2 letra1">
                        ...
                        <div class="col-md-12 mt-3"><strong>SELECCIONE EL COBRO DEL MES:</strong></label>
                            <select class="form-select text-center mt-2" id="desempeño1" name="desempeño1"
                                onchange="calcular();" aria-label="Default select example">

                                <option selected value="">MES A DESEMPEÑAR</option>
                                <option value="{{ $dato_prenda->desempeño }}"
                                    data-prestamo="{{ $dato_prenda->prestamo_prenda }}"
                                    data-interes="{{ $dato_prenda->interes }}"
                                    data-almacenaje="{{ $dato_prenda->almacenaje }}" data-iva="{{ $dato_prenda->iva }}"
                                    data-subtotal="{{ $dato_prenda->subtotal }}"
                                    data-refrendo="{{ $dato_prenda->refrendo }}">1° Mes /
                                    {{ \Carbon\Carbon::parse($dato_prenda->mes1)->formatLocalized('%d-%B-%Y') }}</option>
                                <option value="{{ $dato_prenda->desempeño2 }}"
                                    data-prestamo="{{ $dato_prenda->prestamo_prenda }}"
                                    data-interes="{{ $dato_prenda->interes2 }}"
                                    data-almacenaje="{{ $dato_prenda->almacenaje2 }}" data-iva="{{ $dato_prenda->iva2 }}"
                                    data-subtotal="{{ $dato_prenda->subtotal2 }}"
                                    data-refrendo="{{ $dato_prenda->refrendo }}">2° Mes /
                                    {{ \Carbon\Carbon::parse($dato_prenda->mes2)->formatLocalized('%d-%B-%Y') }}</option>
                                <option value="{{ $dato_prenda->desempeño3 }}"
                                    data-prestamo="{{ $dato_prenda->prestamo_prenda }}"
                                    data-interes="{{ $dato_prenda->interes3 }}"
                                    data-almacenaje="{{ $dato_prenda->almacenaje3 }}" data-iva="{{ $dato_prenda->iva3 }}"
                                    data-subtotal="{{ $dato_prenda->subtotal3 }}"
                                    data-refrendo="{{ $dato_prenda->refrendo }}">3° Mes /
                                    {{ \Carbon\Carbon::parse($dato_prenda->mes3)->formatLocalized('%d-%B-%Y') }}</option>
                                <option value="{{ $dato_prenda->desempeño4 }}"
                                    data-prestamo="{{ $dato_prenda->prestamo_prenda }}"
                                    data-interes="{{ $dato_prenda->interes4 }}"
                                    data-almacenaje="{{ $dato_prenda->almacenaje4 }}"
                                    data-iva="{{ $dato_prenda->iva4 }}" data-subtotal="{{ $dato_prenda->subtotal4 }}"
                                    data-refrendo="{{ $dato_prenda->refrendo }}">4° Mes /
                                    {{ \Carbon\Carbon::parse($dato_prenda->mes4)->formatLocalized('%d-%B-%Y') }}</option>
                                <option value="{{ $dato_prenda->desempeño5 }}"
                                    data-prestamo="{{ $dato_prenda->prestamo_prenda }}"
                                    data-interes="{{ $dato_prenda->interes5 }}"
                                    data-almacenaje="{{ $dato_prenda->almacenaje5 }}"
                                    data-iva="{{ $dato_prenda->iva5 }}" data-subtotal="{{ $dato_prenda->subtotal5 }}"
                                    data-refrendo="{{ $dato_prenda->refrendo }}">5° Mes /
                                    {{ \Carbon\Carbon::parse($dato_prenda->mes5)->formatLocalized('%d-%B-%Y') }}</option>
                            </select>
                        </div>


                        <div class="mt-3">
                            <button class="btn btn-primary col-md-12" data-bs-toggle="collapse" href="#collapseExample"
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                ...
                                <div class="input-group has-validation ">
                                    <span class="input-group-text fw-bold signo"
                                        id="inputGroupPrepend">Dias:&nbsp;&nbsp;&nbsp;&nbsp;</span>
                                    <input type="number" id="multa" name="multa" onkeyUp="calcular2();"
                                        value="" class="form-control input_style tamañoletra text-center"
                                        placeholder="0">
                                </div>
                                <div class="input-group has-validation ">
                                    <span class="input-group-text fw-bold signo" id="inputGroupPrepend">Por dia:</span>
                                    <input type="number" id="multa2" name="multa2" onkeyUp="calcular2();"
                                        class="form-control input_style text-center" disabled>
                                </div>
                                <div class="input-group has-validation ">
                                    <span class="input-group-text fw-bold signo" id="inputGroupPrepend">Total: $</span>
                                    <input type="number" id="multa3" name="multa3" onkeyUp="calcular2();"
                                        class="form-control input_style text-center" disabled>
                                </div>
                        ...
                        <div class="flex justify-center">
                            <div class="col-md-12">
                                <div class="input-group has-validation">
                                    ...
                                    <input type="number" id="desempeño2" name="desempeño2"
                                        class="form-control input_style tamañoletra text-center col-md-8"
                                        placeholder="0.00" disabled>
                                    <input type="hidden" id="desempeño22" name="desempeño22" onkeyUp="calcular2();"
                                        class="form-control input_style tamañoletra text-center col-md-8"
                                        placeholder="0.00" disabled>
                        ...
                        <input type="hidden" id="prestamo" name="prestamo"
                            class="form-control input_style tamañoletra text-center col-md-8" placeholder="0.00" disabled>
                        ...
                        <div class=" mb-8 max-w-6xl mx-auto flex items-center justify-center mt-5">
                            <button class="size60 bordes btn btn-primary navbar1 modal55" type="submit" id="btn-submit"
                                data-toggle="modal"
                                data-target="#exampleModal{{ $dato_prenda->id_prendas }}">PAGAR</button>
                        </div>
