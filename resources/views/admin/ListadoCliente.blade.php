                    ...
                    <table class="table table-hover">
                        ...
                        @foreach($lista_clientes as $cliente)
                            ...
                            <tr>
                                ...
                                <td>@if($cliente->tipo_de_identificacion == 1)
                                        INE
                                ...
                                <td><a class="nav-link" href="{{route('editar_cliente')}}" id="navbarDarkDropdownMenuLink"  aria-expanded="false"><button class="ntn btn-primary "><i class="fas fa-edit"></i></button></a></td>
                            </tr>
