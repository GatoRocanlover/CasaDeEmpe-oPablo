                    ...
                    <table class="table table-sm mt-4 table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($prenda->numeros_capital ==0)
                                @else
                                <a class="nav-link text-center" href="{{ route('boleta.vistacapital', [$prenda->id_prendas]) }}" id="navbarDarkDropdownMenuLink" aria-expanded="false"><i class="fa fa-file-text-o" style="font-size:30px"></i></a>
                                @endif
