            ...
            <div class="tabla justify-content-center">
                <div class="tabla1">
                    ...
                    <div class="col-md-11 mt-4 red1">
                        ...
                        <button class=" size20 bordes btn btn-primary " id="btn_busqueda" type="button"><strong>PRESIONE PARA BUSCAR
                ...
                <div class="tabla2">
                    ...
                    <div class="col-md-12">
                        ...
                        <label for="" class="sub mt-1"><strong>DESCRIPCIÓN:
                            </strong>@if($datoCotizar->caracteristicas_prenda_3 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda.'k'}} {{ $datoCotizar->gramaje_prenda.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2.'k'}} {{ $datoCotizar->gramaje_prenda_2.'gr'}} @elseif($datoCotizar->caracteristicas_prenda_4 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda.'k'}} {{ $datoCotizar->gramaje_prenda.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2.'k'}} {{ $datoCotizar->gramaje_prenda_2.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}@elseif($datoCotizar->caracteristicas_prenda_5 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda.'k'}} {{ $datoCotizar->gramaje_prenda.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2.'k'}} {{ $datoCotizar->gramaje_prenda_2.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_4 }} {{ $datoCotizar->kilataje_prenda_4.'k'}} {{ $datoCotizar->gramaje_prenda_4.'gr'}}@elseif($datoCotizar->caracteristicas_prenda_6 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda.'k'}} {{ $datoCotizar->gramaje_prenda.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2.'k'}} {{ $datoCotizar->gramaje_prenda_2.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_4 }} {{ $datoCotizar->kilataje_prenda_4.'k'}} {{ $datoCotizar->gramaje_prenda_4.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_5 }} {{ $datoCotizar->kilataje_prenda_5.'k'}} {{ $datoCotizar->gramaje_prenda_5.'gr'}}@else{{', '. $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda.'k'}} {{ $datoCotizar->gramaje_prenda.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2.'k'}} {{ $datoCotizar->gramaje_prenda_2.'gr'}} {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_4 }} {{ $datoCotizar->kilataje_prenda_4.'k'}} {{ $datoCotizar->gramaje_prenda_4.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_5 }} {{ $datoCotizar->kilataje_prenda_5.'k'}} {{ $datoCotizar->gramaje_prenda_5.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_6 }} {{ $datoCotizar->kilataje_prenda_6.'k'}} {{ $datoCotizar->gramaje_prenda_6.'gr'}}@endif</label>
                        <input type="hidden" name="caracteristicas_prenda" class="form-control" id="caracteristicas_prenda"
                         value="@if($datoCotizar->caracteristicas_prenda_3 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda}}k {{ $datoCotizar->gramaje_prenda }}gr {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2}}k {{ $datoCotizar->gramaje_prenda_2 }}gr @elseif($datoCotizar->caracteristicas_prenda_4 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda}}k {{ $datoCotizar->gramaje_prenda }}gr {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2}}k {{ $datoCotizar->gramaje_prenda_2 }}gr {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}@elseif($datoCotizar->caracteristicas_prenda_5 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda}}k {{ $datoCotizar->gramaje_prenda }}gr {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2}}k {{ $datoCotizar->gramaje_prenda_2 }}gr {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_4 }} {{ $datoCotizar->kilataje_prenda_4.'k'}} {{ $datoCotizar->gramaje_prenda_4.'gr'}}@elseif($datoCotizar->caracteristicas_prenda_6 == null){{ $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda}}k {{ $datoCotizar->gramaje_prenda }}gr {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2}}k {{ $datoCotizar->gramaje_prenda_2 }}gr {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_4 }} {{ $datoCotizar->kilataje_prenda_4.'k'}} {{ $datoCotizar->gramaje_prenda_4.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_5 }} {{ $datoCotizar->kilataje_prenda_5.'k'}} {{ $datoCotizar->gramaje_prenda_5.'gr'}}@else{{', '. $datoCotizar->caracteristicas_prenda }} {{ $datoCotizar->kilataje_prenda}}k {{ $datoCotizar->gramaje_prenda }}gr {{', '. $datoCotizar->caracteristicas_prenda_2 }} {{ $datoCotizar->kilataje_prenda_2}}k {{ $datoCotizar->gramaje_prenda_2 }}gr {{', '. $datoCotizar->caracteristicas_prenda_3 }} {{ $datoCotizar->kilataje_prenda_3.'k'}} {{ $datoCotizar->gramaje_prenda_3.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_4 }} {{ $datoCotizar->kilataje_prenda_4.'k'}} {{ $datoCotizar->gramaje_prenda_4.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_5 }} {{ $datoCotizar->kilataje_prenda_5.'k'}} {{ $datoCotizar->gramaje_prenda_5.'gr'}}{{', '. $datoCotizar->caracteristicas_prenda_6 }} {{ $datoCotizar->kilataje_prenda_6.'k'}} {{ $datoCotizar->gramaje_prenda_6.'gr'}}@endif" readonly>
