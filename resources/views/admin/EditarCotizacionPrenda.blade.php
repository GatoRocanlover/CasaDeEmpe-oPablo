 ...
 <!-- encabezado -->
        <div class="size">
            ...
            <div class="mt-8 max-w-6xl mx-auto items-center justify-center flex negritas  texto size50 fondoformulario">
                <form action="{{Route('cotizacionprenda.update',$dato_prenda_cotizar->id_cotizacionprenda)}}"
                ...
                <label for="validationCustom03" class="form-label mt-8 text-center">EDITAR DATOS DE PRENDA</label>
                    <div class="col-md-8">
                            ...
                            <input type="text" name="nombre_prenda" class="form-control" id="nombre_prenda" value="{{$dato_prenda_cotizar->nombre_prenda}}" required>                        
                    ...
                    <div class="col-md-8">DESCRIPCION GENERICA</label>
                        <select class="form-select" name="descripcion_generica" id="descripcion_generica" aria-label="Default select example">
                            ...
                            @if($dato_prenda_cotizar->descripcion_generica == -1)
                            ...
                            @if($dato_prenda_cotizar->descripcion_generica == 2) 
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="kilataje_prenda" class="form-control" id="kilataje_prenda" value="{{$dato_prenda_cotizar->kilataje_prenda}}" required>
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="input-group has-validation">
                        <input type="text" name="gramaje_prenda" class="form-control" id="gramaje_prenda" value="{{$dato_prenda_cotizar->gramaje_prenda}}" required>
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                        </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <textarea name="caracteristicas_prenda" class="form-control " id="caracteristicas_prenda"  requiredrows="3">{{$dato_prenda_cotizar->caracteristicas_prenda}}</textarea>
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                    </div>
                    <div class="col-md-8">
                        ...
                        <input type="text" name="avaluo_prenda" class="form-control" id="avaluo_prenda" value="{{$dato_prenda_cotizar->avaluo_prenda}}" required>
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                    </div>
                    <div class="col-md-8">PORCENTAJE DE PRESTAMO SOBRE AVALUO</label>
                        <select class="form-select" id="porcentaje_prestamo_sobre_avaluo" name="porcentaje_prestamo_sobre_avaluo" aria-label="Default select example">
                            ...
                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == -1)
                            ...
                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 2)
                                <option selected value="2">50 %</option>
                            @else
                                <option value="2" >50 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 3)
                                <option selected value="3">55 %</option>
                            @else
                                <option value="3" >55 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 4)
                            ...
                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 6)
                                <option selected value="6">70 %</option>
                            @else
                                <option value="6" >70 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 7)
                                <option selected value="7">75 %</option>
                            @else
                                <option value="7" >75 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 8)
                                <option selected value="8">80 %</option>
                            @else
                                <option value="8" >80 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 9)
                                <option selected value="9">85 %</option>
                            @else
                                <option value="9" >85 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 10)
                                <option selected value="10">90 %</option>
                            @else
                                <option value="10" >90 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 11)
                                <option selected value="11">95 %</option>
                            @else
                                <option value="11" >95 %</option>
                            @endif

                            @if($dato_prenda_cotizar->porcentaje_prestamo_sobre_avaluo == 12)
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" name="prestamo_prenda" class="form-control" id="prestamo_prenda" value="{{$dato_prenda_cotizar->prestamo_prenda}}" required>
                        <div class="valid-feedback">
                        Looks good!
                        </div>
                    </div>
